...
import (
	...
	lru "github.com/theQRL/go-zond/common/lru"
...
type Clique struct {
	...
	db     zonddb.Database       // Database to store and retrieve snapshot checkpoints
...
func New(config *params.CliqueConfig, db zonddb.Database) *Clique {
