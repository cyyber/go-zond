...
func newTestFilterSystem(t testing.TB, db qrldb.Database, cfg Config) (*testBackend, *FilterSystem) {
...
func TestPendingTxFilter(t *testing.T) {
	...
	var (
		...
		to, _        = common.NewAddressFromString("Q00000000000000000000000000000000000000000000000000000000b794f5ea0ba39494ce83a213fffba74279579268")
...
func TestPendingTxFilterFullTx(t *testing.T) {
	...
	for {
		...
		tx := results.([]*qrlapi.RPCTransaction)
		txs = append(txs, tx...)
...
func TestLogFilter(t *testing.T) {
	...
	var (
		...
		firstAddr, _   = common.NewAddressFromString("Q111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111")
		secondAddr, _  = common.NewAddressFromString("Q222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222")
		thirdAddr, _   = common.NewAddressFromString("Q333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333")
		notUsedAddr, _ = common.NewAddressFromString("Q999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999")
