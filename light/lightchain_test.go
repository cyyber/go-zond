...
func makeHeaderChain(parent *types.Header, n int, db zonddb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (zonddb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() zonddb.Database {
	return odr.db
}
