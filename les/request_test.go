...
type accessTestFn func(db zonddb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db zonddb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db zonddb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db zonddb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db zonddb.Database, bhash common.Hash, num uint64) light.OdrRequest {
