...
func newTestClientHandler(backend *backends.SimulatedBackend, odr *LesOdr, indexers []*core.ChainIndexer, db zonddb.Database, peers *serverPeerSet) (*clientHandler, func()) {
	var (
