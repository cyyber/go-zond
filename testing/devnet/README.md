...
go-qrl tree, and waits for readiness. It does not run tests.
...
Go tooling can import `github.com/theQRL/go-qrl/testing/devnet` and call
`devnet.Inspect(ctx)` to discover the live RPC, GraphQL, and WebSocket
endpoints. The separately maintained
