...
The transaction scenario derives its chain ID, nonce, and fees from the live
network, submits the Clef-signed transaction, and requires a successful receipt.
