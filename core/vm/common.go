...
// stackToAddress extracts a 48-byte address from the low 48 bytes of a 512-bit
// stack value (the rightmost 48 bytes of the big-endian 64-byte representation).
func stackToAddress(val *uint512.Int) common.Address {
	b := val.Bytes64()
	return common.BytesToAddress(b[16:])
}
