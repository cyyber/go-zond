...
func makeTestState() (zonddb.Database, Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db zonddb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db zonddb.Database, root common.Hash) error {
...
func checkStateConsistency(db zonddb.Database, root common.Hash) error {
