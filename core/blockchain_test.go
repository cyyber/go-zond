...
func newCanonical(engine consensus.Engine, n int, full bool) (zonddb.Database, *Genesis, *BlockChain, error) {
	var (
		genesis = &Genesis{
...
//
// Details at:
//   - https://github.com/theQRL/go-zond/issues/18977
//   - https://github.com/theQRL/go-zond/pull/18988
