...
func TestCreation(t *testing.T) {
	...
	tests := []struct {
		...
		// Mainnet test cases
		{
			...
			[]testcase{
				{0, 0, ID{Hash: checksumToBytes(0xb8385424), Next: 0}},
...
func TestValidation(t *testing.T) {
	tests := []struct {
		...
		{params.MainnetChainConfig, 15050000, 20000000, ID{Hash: checksumToBytes(0xb8385424), Next: 0}, nil},
		...
		{params.MainnetChainConfig, 15050000, 20000000, ID{Hash: checksumToBytes(0xb8385424), Next: math.MaxUint64}, nil},
		...
		{params.MainnetChainConfig, 88888888, 8888888888, ID{Hash: checksumToBytes(0xb8385424), Next: 8888888888}, ErrLocalIncompatibleOrStale},
	}
	for i, tt := range tests {
