...
func (ec *Client) SyncProgress(ctx context.Context) (*zond.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) FilterLogs(ctx context.Context, q zond.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q zond.FilterQuery, ch chan<- types.Log) (zond.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q zond.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg zond.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg zond.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*zond.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg zond.CallMsg) (uint64, error) {
...
func (p *rpcProgress) toSyncProgress() *zond.SyncProgress {
	if p == nil {
		return nil
	}
