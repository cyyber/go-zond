...
func New(file string, cache int, handles int, namespace string, readonly bool) (*Database, error) {
	...
	// Disable seek compaction explicitly. Check https://github.com/theQRL/go-zond/pull/20130
	// for more details.
...
func (d *Database) NewBatch() zonddb.Batch {
	return &batch{
		b:  d.db.NewBatch(),
		db: d,
	}
...
func (d *Database) NewBatchWithSize(_ int) zonddb.Batch {
	return &batch{
		b:  d.db.NewBatch(),
		db: d,
	}
...
func (d *Database) NewSnapshot() (zonddb.Snapshot, error) {
...
func (b *batch) Replay(w zonddb.KeyValueWriter) error {
	reader := b.b.Reader()
	for {
...
func (d *Database) NewIterator(prefix []byte, start []byte) zonddb.Iterator {
