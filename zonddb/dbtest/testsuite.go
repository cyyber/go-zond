...
// implementation.
func TestDatabaseSuite(t *testing.T, New func() zonddb.KeyValueStore) {
...
// implementation.
func BenchDatabaseSuite(b *testing.B, New func() zonddb.KeyValueStore) {
	var (
...
func iterateKeys(it zonddb.Iterator) []string {
	keys := []string{}
	for it.Next() {
