...
class StdIOHandler:
    ...
    def approveSignData(self, req):
        ...
        {"jsonrpc":"2.0","id":8,"method":"ui_approveSignData","params":[{"content_type":"application/x-clique-header","address":"Q69be3d04d5e9c47341a9cb58f4cba97a7d56aebe57d64d24c687b73c8e9833b4b7485d775f3a50213b7776ea8f7ee75c726497af8de0cb1264b0ee592083b5d1","raw_data":"","messages":[{"name":"Clique header","value":"clique header 1337 [0x44381ab449d77774874aca34634cb53bc21bd22aef2d3d4cf40e51176cb585ec]","type":"clique"}],"call_info":null,"hash":"0xa47ab61438a12a06c81420e308c2b7aae44e9cd837a5df70dd021421c0f58643","meta":{"remote":"clef binary","local":"main","scheme":"in-proc","User-Agent":"","Origin":""}}]}
        """  # noqa: E501
        message = (
            "Sign data request:\n"
            "\t{meta_string}\n"
